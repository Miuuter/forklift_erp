...
- 新增 V41–V43；V37–V40 保持不可修改。

### 验证

- 前端质量检查和 4 项 Vitest 测试通过。
- 138 项 Java 单元测试通过，JaCoCo 基线已记录。
- 48 项 MySQL Testcontainers 集成测试和 7 项 Playwright 端到端冒烟测试通过。
- V1 空库迁移至 V43、V36 历史夹具升级至 V43 均通过，Flyway 校验无差异。
